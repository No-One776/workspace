...
public class Presenter {
	...
	class DrawToppingListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			try {
				// Draw topping cards, go to the next player, and continue
				// running the game
	...
	class SkipListener implements ActionListener {
		...
		@Override
		public void actionPerformed(ActionEvent e) {
			// If the supply is empty, allow the player to skip drawing any
			// cards
	...
	class NewGameListener implements ActionListener {
		...
		@Override
		public void actionPerformed(ActionEvent e) {
			// Make a new game to use and run the game
			engine = engine.newGame();
			runGame();
		}
