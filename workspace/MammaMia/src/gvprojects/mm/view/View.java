...
public class View {
	 ...
	 * listeners from the card, if any
	 * 
	 * @param cardListener
	...
	/**
	 * Adds a ActionListener to the Done button
	 * 
	 * @param doneListener
	 *            the listener to use
	 */
	...
	/**
	 * Adds a ActionListener to the DrawTopping button
	 * 
	 * @param drawListener
	 *            the listener to use
	 */
	...
	/**
	 * Adds a ActionListener to the DrawRecipe button
	 * 
	 * @param drawListener
	 *            the listener to use
	 */
	...
	/**
	 * Sets the draw buttons enabled and disables the other unneccesary buttons
	 */
	public void draw() {
	...
	/**
	 * Draws the specified card as taken with a new border
	 * 
	 * @param x
	 *            the card to draw as taken
	 */
	...
	/**
	 * Draws the specified card as not taken by an empty border
	 * 
	 * @param x
	 *            the card to undraw
	 */
	...
	/**
	 * Disables the draw buttons and enables the done & reset select buttons
	 */
	...
	/**
	 * Adds a listener to the skip draw button
	 * 
	 * @param skipListener
	 *            the listener to use
	 */
	...
	/**
	 * Updates the winners[win] score plus 1 point
	 * 
	 * @param win
	 *            the player to add score too
	 */
	...
	/**
	 * Adds a listener to the JMenuItem to make a new game
	 * 
